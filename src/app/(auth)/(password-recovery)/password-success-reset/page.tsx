...
export default function PasswordSuccessResetPage() {
	return (
		<div className='flex flex-col gap-4 items-center '>
			...
			<Link
				href={'/dashboard'}
				className='w-full text-center bg-primary-color px-4 py-2 border text-white rounded-lg hover:bg-primary-color-hover transition-colors ease-linear duration-75'
			>
				Continue
			</Link>
		</div>
